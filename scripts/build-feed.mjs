...
const SOURCES = [
  ...
  },
  {
    ...
    category: '개발',
    listUrl: 'https://aws.amazon.com/blogs/architecture/feed/',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '아키텍처'],
    includeKeywords: ['architecture', 'multi-tenant', 'resilien', 'recovery', 'cache', 'event', 'queue', 'database', 'distributed', 'deployment', 'inference', 'latency', 'scaling', 'observability'],
  },
  {
    kind: 'rss',
    format: 'atom',
    ...
    category: '개발',
    listUrl: 'https://www.martinfowler.com/feed.atom',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '아키텍처'],
    includeKeywords: ['architecture', 'mechanical sympathy', 'decision record', 'coding agent', 'team standards', 'context anchoring', 'refactoring', 'microservice', 'platform', 'workflow', 'integration', 'event'],
    excludeKeywords: ['fragments'],
  },
  {
    kind: 'rss',
    format: 'rss',
    source: 'Cloudflare Architecture',
    category: '개발',
    listUrl: 'https://blog.cloudflare.com/tag/architecture/rss/',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '아키텍처'],
  },
  {
    ...
    category: '개발',
    listUrl: 'https://prometheus.io/blog/feed.xml',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '관측성'],
    includeKeywords: ['observability', 'monitoring', 'metrics', 'alert', 'query', 'storage', 'performance', 'kubernetes', 'remote write', 'io', 'relabel', 'function', 'composite types', 'otel'],
    excludeKeywords: ['promcon', 'working group', 'non-developers', 'community'],
  },
  {
    kind: 'rss',
    format: 'rss',
    source: 'Grafana Blog',
    category: '개발',
    listUrl: 'https://grafana.com/blog/news.xml',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '관측성'],
    includeKeywords: ['grafana', 'observability', 'monitoring', 'alert', 'incident', 'performance', 'profil', 'tracing', 'logs', 'metrics', 'kubernetes', 'helm'],
    excludeKeywords: ['grafanacon', 'conference'],
  },
  {
    kind: 'rss',
    format: 'rss',
    ...
    category: '개발',
    listUrl: 'https://opentelemetry.io/blog/index.xml',
    maxItems: 2,
    extraTags: ['개발', '글로벌', '관측성'],
    includeKeywords: ['observability', 'metrics', 'traces', 'tracing', 'incident', 'pipeline', 'scale', 'profil', 'sdk', 'instrumentation', 'collector', 'production', 'semantic', 'configuration', 'ebpf'],
    excludeKeywords: ['review', 'good first issue', 'kubecon'],
  },
  {
    kind: 'rss',
    format: 'rss',
